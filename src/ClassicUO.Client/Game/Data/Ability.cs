...
namespace ClassicUO.Game.Data
{
    ...
    {
        public static readonly AbilityDefinition[] Abilities = new AbilityDefinition[]
        {
        ...
        public static readonly Dictionary<ushort, ItemAbilities> GraphicToAbilitiesMap = new()
        {
            ...
            { 0xA291, new (0xA291, Ability.ConcussionBlow, Ability.WhirlwindAttack) }, // Barbed Whip (Flipped ID)
            { 0xA28A, new (0xA28A, Ability.ArmorPierce, Ability.WhirlwindAttack) },    // Spiked Whip
            { 0xA292, new (0xA292, Ability.ArmorPierce, Ability.WhirlwindAttack) },    // Spiked Whip (Flipped ID)
